        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          <div>
            <div className="flex justify-center md:justify-start items-center text-2xl font-bold mb-6">
              <Image
                src="/images/Firevolt_CenteredLogo(Gradient-DBG).png"
                alt="Fire Volt Logo"
                width={180}
                height={100}
              />
            </div>
            <p className="text-center md:text-left mb-6 text-secondary-300">
              Fire compliance services for your business, that takes you to the
              next level.
            </p>
            <div className="flex justify-around pr-5">
              <Link
                aria-label="Facebook Firevolt Link"
                href="https://www.facebook.com/people/Firevolt/100086488210335/"
                className="w-10 h-10 bg-secondary-700 rounded-full flex items-center justify-center hover:bg-primary-600 transition text-secondary-300 hover:text-white"
              >
                <FontAwesomeIcon icon={faFacebook} />
              </Link>

              <Link
                aria-label="Linkedin Firevolt Link"
                href="https://www.linkedin.com/company/firevolt/"
                className="w-10 h-10 bg-secondary-700 rounded-full flex items-center justify-center hover:bg-primary-600 transition text-secondary-300 hover:text-white"
              >
                <FontAwesomeIcon icon={faLinkedin} />
              </Link>
              <Link
                aria-label="Instagram Firevolt Link"
                href="https://www.instagram.com/firevolt._/"
                className="w-10 h-10 bg-secondary-700 rounded-full flex items-center justify-center hover:bg-primary-600 transition text-secondary-300 hover:text-white"
              >
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link
                  href="/services"
                  className="text-secondary-300 hover:text-primary-400 transition"
                >
                  Fire Safety
                </Link>
              </li>
        ...
        <div className="pt-6 border-t border-secondary-800 text-secondary-400 text-[15px]">
          <div className="flex flex-col gap-3 md:flex-row items-center justify-center md:space-x-4 text-center z-50">
            ...
            <Link
              ...
              className="hover:text-primary-400 transition"
              aria-label="Powered by Nexa Web"
            >
              Powered By Nexa Web
            </Link>
