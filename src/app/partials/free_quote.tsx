          ...
          >
            <div className="bg-white p-8 m-6 rounded-lg shadow-lg max-w-md w-full overflow-y-auto max-h-[90%] relative">
              <button
                id="close-popup"
                onClick={togglePopup}
                className="absolute top-3 right-3 text-secondary-500 hover:text-secondary-700 transition"
              >
                <svg
              ...
              <div className="mb-6 text-center">
                ...
                <strong className="text-secondary-500 p-2 inline-block">
                  Don&apos;t have time?
                </strong>
                ...
                <div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <input
                      ...
                      required
                      placeholder="?"
                      className="w-24 px-3 py-2 border border-primary-300 text-black rounded-lg shadow-sm focus:outline-none focus:ring-1 focus:ring-primary-500 focus:border-white-500 transition duration-200 bg-white-800 placeholder-secondary-400"
                    />
                    <button
                      type="button"
