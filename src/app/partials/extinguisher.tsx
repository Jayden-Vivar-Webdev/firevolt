          ...
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2 order-2 lg:order-1">
              ...
              <h2 className="text-3xl md:text-4xl font-bold mb-6">
                Extinguisher & Fire Equipment Services
              </h2>
              <p className="text-lg text-secondary-600 mb-8">
                Regular maintenance and testing of your fire equipment is not
                just a legal requirement - it&apos;s critical for ensuring the
                safety of your workplace. We provide comprehensive servicing for
                all types of fire safety equipment.
              </p>
              ...
              <div className="bg-primary-50 border-l-4 border-primary-600 p-4 rounded-r-lg mb-8">
                ...
                <p className="text-secondary-700">
                  Under Australian Standard AS1851, all fire protection
                  equipment must be regularly tested and maintained. Failure to
                  comply can result in fines and void insurance coverage.
                </p>
              </div>

              <a
                href="/contact"
                className="inline-flex items-center justify-center bg-primary-10 hover:bg-primary-700 text-white px-6 py-3 rounded-lg font-bold transition shadow-md hover:shadow-lg"
              >
