  ...
  return (
    <>
      ...
      <section className="hero-bg text-white py-24 md:py-32">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg md:text-xl max-w-3xl mx-auto mb-10 text-secondary-200">
            For over 5+ years, Firevolt has been helping clients achieve fire
            safety through innovative solutions and personalized service.
          </p>
          <a
            href="#our-team"
            className="inline-block bg-primary-10 text-white px-8 py-3 rounded-lg font-bold hover:bg-primary-700 transition transform hover:-translate-y-1 shadow-lg hover:shadow-xl"
          >
            Meet Our Team
          </a>
        </div>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="lg:w-1/2">
              ...
              <h2 className="text-3xl md:text-4xl font-bold mb-6">
                Trusted Fire Partners Since 2020
              </h2>
              <p className="text-secondary-600 mb-6">
                Firevolt was founded on the principle that everyone deserves
                access to professional fire protection, regardless of situation.
                What began as a small fire protection business in Brisbane has
                grown into a widely recognised fire protection company serving
                clients across the country.
              </p>
              <p className="text-secondary-600 mb-8">
                Our independence empowers us to deliver genuinely objective fire
                protection services. We’re proud to act with integrity, always
                prioritizing the safety, compliance, and best interests of our
                clients.
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="values-card bg-white p-6 rounded-xl shadow-md border border-gray-100 transition duration-300 hover:shadow-lg">
              ...
              <p className="text-secondary-600 text-sm">
                We adhere to the highest ethical standards, providing honest
                advice even when it&apos;s not the easiest path.
              </p>
            </div>
            ...
            <div className="values-card bg-white p-6 rounded-xl shadow-md border border-gray-100 transition duration-300 hover:shadow-lg">
              ...
              <p className="text-secondary-600 text-sm">
                We continuously evolve our strategies to leverage the latest
                fire protection research and technological advancements.
              </p>
            </div>
            ...
            <div className="values-card bg-white p-6 rounded-xl shadow-md border border-gray-100 transition duration-300 hover:shadow-lg">
              ...
              <p className="text-secondary-600 text-sm">
                Your success is our success. We listen first, then craft
            ...
            <div className="values-card bg-white p-6 rounded-xl shadow-md border border-gray-100 transition duration-300 hover:shadow-lg">
              ...
              <p className="text-secondary-600 text-sm">
                We pursue mastery in our craft, combining deep expertise with
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-secondary-200 max-w-2xl mx-auto">
              Milestones in our journey to becoming a trusted partner for fire
          ...
          <div className="max-w-4xl mx-auto relative pl-8">
            ...
            <div className="relative mb-12 timeline-item pl-8">
              <div className="relative bg-white/10 backdrop-blur-sm p-6 rounded-xl border border-white/20">
                <h3 className="text-xl font-bold mb-2">
                  {" "}
                  2022 January - Founding
                </h3>
                <p className="text-secondary-200 mb-2">Firevolt is founded.</p>
            ...
            <div className="relative mb-12 timeline-item pl-8">
              <div className="relative bg-white/10 backdrop-blur-sm p-6 rounded-xl border border-white/20">
                <h3 className="text-xl font-bold mb-2">
                  2023 March - First Expansion
                </h3>
                <p className="text-secondary-200 mb-2">
                  We gain our first client and start to supporting local
                  businesses.
                </p>
            ...
            <div className="relative mb-12 timeline-item pl-8">
              <div className="relative bg-white/10 backdrop-blur-sm p-6 rounded-xl border border-white/20">
                <h3 className="text-xl font-bold mb-2">
                  2023 April - Downer Contract
                </h3>
                <p className="text-secondary-200 mb-2">
                  Firevolt to service Queensland defence bases.
                </p>
            ...
            <div className="relative mb-12 timeline-item pl-8">
              <div className="relative bg-white/10 backdrop-blur-sm p-6 rounded-xl border border-white/20">
                <h3 className="text-xl font-bold mb-2">
                  2024 January - Expansion
                </h3>
                <p className="text-secondary-200 mb-2">
                  Firevolt expanded its service to help support our clients.
                </p>
                <span className="text-sm text-primary-300">
                  January 8, 2022
                </span>
            ...
            <div className="relative timeline-item pl-8">
              <div className="relative bg-white/10 backdrop-blur-sm p-6 rounded-xl border border-white/20">
                ...
                <p className="text-secondary-200 mb-2">
                  Serving over 100+ businesses in Brisbane and surrounding
                  areas.
                </p>
      ...
      <section className="py-20 bg-primary-10 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">
            Ready to Experience the Firevolt Difference?
          </h2>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <a
              href="/contact"
              className="bg-white text-primary-600 px-8 py-3 rounded-lg font-bold hover:bg-gray-100 transition transform hover:-translate-y-1 shadow-lg hover:shadow-xl"
            >
              Contact Us
            </a>
            <a
