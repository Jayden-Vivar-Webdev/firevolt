...
const ContactPage = () => {
  ...
  const validateRecaptcha = async () => {
    try {
      if (!executeRecaptcha) {
        setFormStatus("Not available to execute recaptcha");
        return false;
      }
      ...
      if (response?.data?.success === true) {
        ...
        setFormStatus("Failed reCAPTCHA verification. Please try again.");
        return false;
      }
      ...
      setFormStatus("Failed to execute reCAPTCHA. Please try again.");
      return false;
    }
  };
      ...
      <section className="contact-hero text-white py-24 md:py-32">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
            Contact Our Firevolt Specialists
          </h1>
          <p className="text-lg md:text-xl max-w-3xl mx-auto text-secondary-200">
            Have questions about our services or need fire safety advice? Reach
            out to our team of certified professionals.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="contact-card bg-white p-8 rounded-xl shadow-md hover:shadow-lg transition duration-300 border border-gray-100">
              ...
              <p className="text-secondary-600 text-center mb-4">
                Speak directly with a Firevolt specialist.
              </p>
              <div className="text-center">
                <a
                  href="tel:+18001234567"
                  className="text-primary-600 font-semibold hover:text-primary-800 transition"
                >
                  1300 533 294
                </a>
                <p className="text-sm text-secondary-500 mt-1">
                  Mon-Fri, 6am-5.30pm AEST | Sat, 8am-12pm AEST
                </p>
              </div>
            </div>
            ...
            <div className="contact-card bg-white p-8 rounded-xl shadow-md hover:shadow-lg transition duration-300 border border-gray-100">
              ...
              <div className="text-center">
                <a
                  href="mailto:service@firevolt.com.au"
                  className="text-primary-600 font-semibold hover:text-primary-800 transition"
                >
            ...
            <div className="contact-card bg-white p-8 rounded-xl shadow-md hover:shadow-lg transition duration-300 border border-gray-100">
              ...
              <div className="text-center">
                ...
                <a
                  ...
                  className="text-primary-600 text-sm font-semibold hover:text-primary-800 transition mt-2 inline-block"
                >
                  Google Maps →
                </a>
              </div>
            ...
            <div className="md:flex">
              <div className="md:w-1/2 bg-primary-10 text-white p-8 md:p-12">
                ...
                <p className="mb-6 text-primary-100">
                  Fill out the form and one of our Firevolt specialists will
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    <FontAwesomeIcon
                      icon={faUserTie}
                      className="mt-1 mr-4 text-primary-300"
                    />
                    <div>
                      <h4 className="font-bold">Firevolt Specialists</h4>
                      <p className="text-primary-200 text-sm">
                        All our consultants are certified specialists.
                      </p>
                    </div>
                  </div>
              ...
              <div className="md:w-1/2 p-8 md:p-12">
                ...
                <form action={submitForm}>
                  ...
                  <button
                    type="submit"
                    className="w-full bg-primary-10 text-white py-3 px-6 rounded-lg font-bold hover:bg-primary-700 transition shadow-md hover:shadow-lg"
                  >
                    Send Message
                  </button>
                </form>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              View Servicing Locations
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              We&apos;re conveniently located to serve your safety compliance
            ...
            <div className="lg:w-1/3">
              <div className="bg-white p-8 rounded-xl shadow-lg h-full border border-gray-200">
                <div className="flex items-center mb-6">
                  <FontAwesomeIcon
                    icon={faMapMarkerAlt}
                    className="text-primary-500 text-2xl mr-4"
                  />
                  <div>
                ...
                <div className="space-y-6">
                  <div className="flex items-start">
                    <FontAwesomeIcon
                      icon={faPhone}
                      className="text-primary-500 mt-1 mr-4 text-lg"
                    />
                    <div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-secondary-600 max-w-2xl mx-auto">
              Find answers to common questions about our fire safety services.
            </p>
          </div>
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="mb-4 border-b border-gray-200 pb-4">
              ...
              {isFaqOpen1 && (
                <div className="faq-content mt-2 text-secondary-600">
                  <p>
                    We provide fire safety services in Queensland, to see our
                    service area please locate our map on this page and see the
                    servicing area. We believe in accessible fire safety advice
                    for everyone.
                  </p>
                </div>
              )}
            ...
            <div className="mb-4 border-b border-gray-200 pb-4">
              ...
              {isFaqOpen2 && (
                <div className="faq-content mt-2 text-secondary-600">
                  <p>
                    We offer contracts for customers. Please contact us to
                    discuss your needs.
                  </p>
                </div>
              )}
            ...
            <div className="mb-4 border-b border-gray-200 pb-4">
              ...
              >
                <span>
                  What makes Firevolt different from other fire safety firms?
                </span>
                <i className="fas fa-chevron-down text-primary-600 transition-transform duration-300"></i>
              </button>
              {isFaqOpen3 && (
                <div className="faq-content mt-2 text-secondary-600">
                  <p>
                    ...
                    personalised service. We use advanced experience to optimise
                    your fire safety and compliance measures.
                  </p>
                </div>
              )}
            </div>
            ...
            <div className="mb-4 border-b border-gray-200 pb-4">
              ...
              {isFaqOpen4 && (
                <div className="faq-content mt-2 text-secondary-600">
                  <p>
                    We typically schedule quarterly check-ins, but the frequency
                    can be adjusted based on your needs. Between meetings
                    you&apos;ll have access to our fire safety experts.
            ...
            <div className="mb-4 border-b border-gray-200 pb-4">
              ...
              >
                <span>
                  Is my business and fire safety procedures secure with
                  Firevolt?
                </span>
                <i className="fas fa-chevron-down text-primary-600 transition-transform duration-300"></i>
              </button>
              {isFaqOpen5 && (
                <div className="faq-content mt-2 text-secondary-600">
                  <p>
                    Absolutely. We use encryption for all data transmissions and
                    storage. Our systems undergo regular security audits, and we
                    adhere to strict privacy policies. Your information is never
      ...
      <section className="py-16 bg-primary-10 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-2xl md:text-3xl font-bold mb-6">
            Ready to Start Your Fire Safety Journey?
          </h2>
          <p className="text-lg max-w-2xl mx-auto mb-8 text-primary-100">
            Schedule a free consultation with one of our Firevolt specialists
            today.
          </p>
          <a
            href="#contact-us"
            className="inline-block bg-white text-primary-10 px-8 py-3 rounded-lg font-bold hover:bg-gray-100 transition transform hover:-translate-y-1 shadow-lg hover:shadow-xl"
          >
            Book a Consultation
          </a>
        </div>
