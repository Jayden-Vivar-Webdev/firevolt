...
const HomePage = () => {
  ...
  async function submitForm(formData: FormData): Promise<void> {
    const formValues = {
      ...
      message:
        "The client has downloaded the Emergency Preparedness Fact Sheet they may need your services.",
    };
    ...
    try {
      ...
      if (response.ok) {
        window.location.href =
          "https://irp.cdn-website.com/94ddd8b4/files/uploaded/Firevolt%20-%20Emergency%20Plans%20fact%20Sheet.pdf";
  ...
  const infoSection = [
    {
      ...
      components: {
        ...
        points: [
          "Floor plan with clear exit routes",
          "Assembly area locations",
          "Emergency equipment locations",
          "You Are Here indicators",
          "Standardized emergency symbols",
    ...
    },
    {
      ...
      components: {
        ...
        points: [
          'Diagrams must include the "You Are Here" location',
          "The evacuation diagram must be correctly oriented",
          "Diagrams must be displayed in conspicuous positions",
          "Must use standardised symbols",
          ,
    ...
    },
    {
      ...
      components: {
        ...
        points: [
          "Visable and easily accessible",
          "Height guidelines 1200 mm and 1600 mm from the floor",
          "Place diagrams at key decision points",
          "Large or complex buildings require multiple diagrams",
          "Key Location",
          "Diagrams must be permanently affixed",
        ],
        src: "/images/evac_template.png",
    ...
    },
    {
      ...
      components: {
        ...
        points: [
          ...
          "Update after building changes",
          "Post renovation checks",
          "Ongoing Maintenance",
          "Annual emergency review",
          "Emergency Planning Committee (EPC) Responsibility",
        ],
        src: "/images/evac_diagram_compliance.jpg",
    ...
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-secondary-600 max-w-2xl mx-auto">
              We offer a range of services to help you stay compliant and safe.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 lg:grid-cols-2 gap-8">
            ...
            <div className="service-card bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition duration-300 border border-gray-100">
              <div className="service-img h-48 overflow-hidden relative">
                ...
                />
                <span className="absolute top-4 right-4 bg-primary-10 text-white text-xs font-semibold px-3 py-1 rounded-full z-20">
                  Highly Rated
                </span>
              </div>
              <div className="p-6">
                ...
                <a
                  href="/contact"
                  className="block w-full bg-primary-10 hover:bg-primary-700 text-white text-center py-2 px-4 rounded-lg font-medium transition shadow-md hover:shadow-lg"
                >
                  Contact Us
                </a>
              </div>
      ...
      <section className="py-20" id="features">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div
              data-name="car-loan"
              className="feature-card bg-white p-8 rounded-xl shadow-md hover:shadow-lg transition duration-300 border border-gray-100 js-open-popup"
            >
              ...
              <p className="text-secondary-600">
                Free up time and resources to concentrate on growing your
                business, leaving compliance to us.
              </p>
            </div>

            {/* Feature 2 */}
            <div
              data-name="caravan-loan"
              className="feature-card bg-white p-8 rounded-xl shadow-md hover:shadow-lg transition duration-300 border border-gray-100 js-open-popup"
            >
              <div className="w-14 h-14 bg-primary-50 text-primary-600 rounded-lg flex items-center justify-center text-2xl mb-6 transition duration-500">
              ...
              <p className="text-secondary-600">
                Stay compliant with minimal effort through automated reminders
                and easy scheduling.
              </p>
            </div>
            ...
            >
              ...
              <p className="text-secondary-600">
                Access affordable compliance services designed to fit any
                budget, ensuring that safety is never out of reach.
              </p>
            </div>

            {/* Feature 4 */}
            <div
              data-name="jetski-loan"
              className="feature-card bg-white p-8 rounded-xl shadow-md hover:shadow-lg transition duration-300 border border-gray-100 js-open-popup"
            >
              <div className="w-14 h-14 bg-primary-50 text-primary-600 rounded-lg flex items-center justify-center text-2xl mb-6 transition duration-500">
              ...
              <p className="text-secondary-600">
                Reduce disruptions and Save Time with Firevolts ability to
                service multiple compliance services provided in one visit.
              </p>
            </div>
            <div
              data-name="jetski-loan"
            ...
            >
              ...
              <p className="text-secondary-600">
                All our work is completed to the highest standards, ensuring
            ...
            >
              ...
              <p className="text-secondary-600">
                We offer ongoing support to ensure that your business is always
                compliant.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 text-center">
            ...
            <div className="bg-white/10 backdrop-blur rounded-xl p-8 transform transition duration-300 hover:translate-y-[-8px] hover:bg-white/15 border border-white/20">
              ...
              <h3 className="text-4xl md:text-5xl font-bold mb-2">
                100<span className="text-primary-300">+</span>
              </h3>
              <p className="text-gray-200 uppercase tracking-wider text-sm font-medium">
                Satisfied Companies
              </p>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur rounded-xl p-8 transform transition duration-300 hover:translate-y-[-8px] hover:bg-white/15 border border-white/20">
              ...
              <h3 className="text-4xl md:text-5xl font-bold mb-2">
                5.0<span className="text-3xl">/5.0</span>
              </h3>
              <p className="text-gray-200 uppercase tracking-wider text-sm font-medium">
                Rating on Google
              </p>
            ...
            <div className="bg-white/10 backdrop-blur rounded-xl p-8 transform transition duration-300 hover:translate-y-[-8px] hover:bg-white/15 border border-white/20">
              ...
              <h3 className="text-4xl md:text-5xl font-bold mb-2">
                10<span className="text-primary-300">+</span>
              </h3>
              <p className="text-gray-200 uppercase tracking-wider text-sm font-medium">
                Years Experience
              </p>
      ...
      <section className="py-20 bg-secondary-50" id="testimonials">
        <div className="container mx-auto px-4 ">
          <div className="text-center mb-16">
            ...
            <p className="text-secondary-600 max-w-2xl mx-auto">
              Hear from people who have transformed their business future with
              Firevolt.
            </p>
          </div>
          ...
          <div className="flex overflow-x-auto snap-x snap-mandatory h-fit gap-10 mx-auto hide-scrollbar p-4 scroll-smooth">
            ...
            <div
              ref={testimonial1Ref}
              className="testimonials snap-center min-w-full xl:min-w-[28rem] snap-center bg-white p-8 rounded-xl shadow-lg border border-gray-100"
            >
              <div className="text-lg text-secondary-700 mb-6 relative">
                <span className="absolute -top-4 -left-4 text-primary-400 text-4xl opacity-50">
                  &quot;
                </span>
                Great training today with Fire volt. Very informative and
                professional whilst creating a fantastic fun and learning
                environment. Would highly recommend.
                <span className="absolute -bottom-4 -right-4 text-primary-400 text-4xl opacity-50">
                  &quot;
                </span>
              </div>
            ...
            <div
              ref={testimonial2Ref}
              className="testimonials min-w-full xl:min-w-[28rem] snap-center bg-white p-8 rounded-xl shadow-lg border border-gray-100"
            >
              <div className="text-lg text-secondary-700 mb-6 relative">
                <span className="absolute -top-4 -left-4 text-primary-400 text-4xl opacity-50">
                  &quot;
                </span>
                Thanks so much for our training today at Apollo. Very well done
                and clearly explained and good to get everyone involved to learn
                how to handle a fire blanket and extinguisher.
                <span className="absolute -bottom-4 -right-4 text-primary-400 text-4xl opacity-50">
                  &quot;
                </span>
              </div>
            ...
            >
              <div className="text-lg text-secondary-700 mb-6 relative">
                ...
                Firevolt supplied fire extinguishers and helped make my business
                compliant. He was very helpful, reliable, and provided great
                advice. Highly recommended for any business owners!
                <span className="absolute -bottom-4 -right-4 text-primary-400 text-4xl opacity-50">
                  &quot;
                </span>
              </div>
          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            ...
            <div className="md:w-2/3">
              ...
              <p className="text-secondary-600 mb-6">
                ...
                discipline, and attention to detail we learned in service to
                every fire safety project we undertake. We understand the
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-start">
                  ...
                  <p className="ml-3 text-secondary-700">
                    <strong>Military Precision:</strong> Our service reflects
                    the high standards we learned in the armed forces
                  </p>
                </div>
                <div className="flex items-start">
                  <div className="flex-shrink-0 mt-1">
                  ...
                  <p className="ml-3 text-secondary-700">
                    <strong>Veteran Operated:</strong> We only provide the best
                    service and make it our mission
                  </p>
                </div>
                <div className="flex items-start">
                  <div className="flex-shrink-0 mt-1">
                  ...
                  <p className="ml-3 text-secondary-700">
                    <strong>Community Focused:</strong> Committed to supporting
                    veteran causes and organisations
                  </p>
                </div>
              </div>
              <a
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 overflow-hidden">
              ...
              <div className="p-6">
                <p className="text-secondary-600 mb-4">
                  Comprehensive instruction on leadership during emergencies
                  including:
                </p>
            ...
            <div className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 overflow-hidden">
              ...
              <div className="relative h-70">
                <Image
                  src="/images/emergency-meeting.webp"
                  alt="Chief Warden Training"
                  fill
                  className="object-cover"
                />
            ...
            <div className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 overflow-hidden">
              ...
              <div className="relative h-70">
                <Image
                  src="/images/evacuation-exercise.webp"
                  alt="Chief Warden Training"
                  fill
                  className="object-cover"
                />
      ...
      <section className="py-20 bg-gray-50" id="gallery">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-secondary-600 max-w-2xl mx-auto">
              See our team delivering top-quality fire compliance services for
            ...
            {selectedCategoryData &&
              selectedCategoryData.components.map((component) => {
                return (
                  <div
                    key={component.id}
                    className="gallery-item group relative overflow-hidden rounded-xl shadow-lg transition-all duration-500 hover:shadow-xl border border-gray-100"
                  >
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 text-center">
            ...
            <div className="bg-white/20 backdrop-blur rounded-xl p-8 transform transition duration-300 hover:translate-y-[-8px] hover:bg-white/25 border-2 border-white/30 shadow-lg">
              ...
              <h3 className="text-4xl md:text-5xl font-bold mb-2">
                500<span className="text-white/80">+</span>
              </h3>
              <p className="text-gray-100 uppercase tracking-wider text-sm font-medium">
                Fire Systems Serviced
              </p>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur rounded-xl p-8 transform transition duration-300 hover:translate-y-[-8px] hover:bg-white/15 border border-white/20">
              ...
              <h3 className="text-4xl md:text-5xl font-bold mb-2">
                2,500<span className="text-primary-300">+</span>
              </h3>
              <p className="text-gray-200 uppercase tracking-wider text-sm font-medium">
                People Trained
              </p>
            ...
            <div className="bg-white/10 backdrop-blur rounded-xl p-8 transform transition duration-300 hover:translate-y-[-8px] hover:bg-white/15 border border-white/20">
              ...
              <h3 className="text-4xl md:text-5xl font-bold mb-2">
                300<span className="text-primary-300">+</span>
              </h3>
              <p className="text-gray-200 uppercase tracking-wider text-sm font-medium">
                Evacuation Plans
              </p>
            ...
            <div className="bg-white/10 backdrop-blur rounded-xl p-8 transform transition duration-300 hover:translate-y-[-8px] hover:bg-white/15 border border-white/20">
              ...
              <h3 className="text-4xl md:text-5xl font-bold mb-2">
                24<span className="text-primary-300">/7</span>
              </h3>
              <p className="text-gray-200 uppercase tracking-wider text-sm font-medium">
                Emergency Support
              </p>
          ...
          <div className="flex flex-col lg:flex-row gap-12 items-center">
              ...
              <div className="relative rounded-xl overflow-hidden shadow-lg border border-gray-100">
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-white/90 p-4 text-center">
                  <p className="text-sm font-medium text-gray-700">
                    Sample AS3745-2010 Compliant Evacuation Diagram
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="lg:w-1/1">
              ...
              <p className="text-lg text-secondary-600 mb-8">
                AS3745-2010 compliant diagrams that clearly guide occupants to
                safety during emergencies. Our diagrams are more than just legal
                requirements - they&apos;re potentially life-saving tools for
                your workplace.
              </p>
              ...
              <div className="space-y-6 mb-8">
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-secondary-600">
                      Designed to meet all AS3745-2010 requirements with correct
                      symbols, legends, and formatting
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-secondary-600">
                      Customized to your exact floor plan with all emergency
                      equipment locations marked
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-secondary-600">
                      Most diagrams completed within 48 hours of receiving your
                      floor plans
                    </p>
                  </div>
                </div>
              ...
              <div className="bg-primary-50 border-l-4 border-primary-600 p-4 rounded-r-lg mb-8">
                ...
                <p className="text-secondary-700">
                  Under Australian Standard AS3745-2010, all workplaces must
                  display current evacuation diagrams at all emergency exits and
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a
                  href="/contact"
                  className="bg-primary-10 hover:bg-primary-700 text-white px-6 py-3 rounded-lg font-bold text-center transition shadow-md hover:shadow-lg"
                >
                  Get Your Diagrams
                </a>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-secondary-600 max-w-3xl mx-auto">
              Customized emergency plans that meet AS3745-2010 requirements and
              actually work in real emergency situations.
            </p>
          </div>
            ...
            <div className="flex flex-col justify-between xl:w-1/3">
              ...
              <div className="bg-white rounded-xl shadow-lg p-8 h-auto border border-gray-100">
                <h3 className="text-2xl font-bold mb-6">
                  Why Your Business Needs a Professional Emergency Plan
                </h3>
                ...
                <div className="space-y-6 mb-8">
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-secondary-600">
                        AS3745-2010 requires all Australian workplaces to have a
                        current emergency plan that covers fire, medical
                        emergencies, and other potential incidents.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-secondary-600">
                        Clear procedures reduce panic and ensure everyone knows
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-secondary-600">
                        Proper emergency response can minimize damage to your
                ...
                <div className="mt-8 pt-6 border-t border-gray-200">
                  <a
                    href="/contact"
                    className="inline-flex items-center justify-center bg-primary-10 hover:bg-primary-700 text-white px-6 py-3 rounded-lg font-bold transition shadow-md hover:shadow-lg w-full"
                  >
                ...
                <div className="p-8">
                    ...
                    <div>
                      <div className="flex items-start mb-6">
                        ...
                        <div className="ml-3">
                          ...
                          <p className="text-secondary-600 text-sm">
                            Step-by-step instructions for fire, medical
                            emergencies, chemical spills, and more
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start mb-6">
                        ...
                        <div className="ml-3">
                          ...
                          <p className="text-secondary-600 text-sm">
                            Clear hierarchy of wardens and their specific
                            responsibilities
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start">
                        ...
                        <div className="ml-3">
                          ...
                          <p className="text-secondary-600 text-sm">
                            How to alert staff and emergency services during an
                            incident
                          </p>
                        </div>
                      </div>
                    ...
                    <div>
                      <div className="flex items-start mb-6">
                        ...
                        <div className="ml-3">
                          ...
                          <p className="text-secondary-600 text-sm">
                            Primary and secondary evacuation routes with
                            assembly areas
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start mb-6">
                        ...
                        <div className="ml-3">
                          ...
                          <p className="text-secondary-600 text-sm">
                            All essential contacts including first aid officers
                      ...
                      <div className="flex items-start">
                        ...
                        <div className="ml-3">
                          ...
                          <p className="text-secondary-600 text-sm">
                            Recommended frequency for emergency training and
                            drills
                          </p>
                        </div>
                      </div>
                  ...
                  <div className="mt-8 pt-6 border-t border-gray-200">
                    ...
                    <ol className="space-y-3">
                      <li className="flex items-start">
                        <span className="bg-primary-100 text-primary-600 text-xs font-bold px-2 py-1 rounded mr-3">
                          1
                        </span>
                        <span className="text-secondary-600">
                          Professionally Designed Evacuaction Diagram &
                          Emergency Plan
                        </span>
                      </li>
                      <li className="flex items-start">
                        ...
                        <span className="text-secondary-600">
                          Site assessment to gather information for the diagrams
                          & plan.
                        </span>
                      </li>
                      <li className="flex items-start">
                        ...
                        <span className="text-secondary-600">
                          Your Company logo added to the Diagrams & Plan.
                        </span>
                      </li>
                      <li className="flex items-start">
                        <span className="bg-primary-100 text-primary-600 text-xs font-bold px-2 py-1 rounded mr-3">
                        ...
                        <span className="text-secondary-600">
                          Guaranteed compliance with Australian Standards.
                        </span>
                      </li>
                    </ol>
                  </div>
              ...
              <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100 h-auto lg:mt-12 ">
                ...
                <div className="p-8">
                  <ol className="space-y-6">
                    ...
                    <li className="flex">
                      <div className="flex-shrink-0">
                        <span className="bg-primary-10 text-white text-lg font-bold w-10 h-10 rounded-full flex items-center justify-center mr-4">
                          01
                        </span>
                      </div>
                      <div>
                        ...
                        <p className="text-secondary-600">
                          Reach out by phone, email, or through our contact form
                    ...
                    <li className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-secondary-600">
                          We gather information to create your emergency
                    ...
                    <li className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-secondary-600">
                          We send your newly designed emergency plan and
                          diagrams for your review and approval.
                        </p>
                      </div>
                    </li>
                    ...
                    <li className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-secondary-600">
                          We conduct a final site visit to deliver and install
                          your new emergency plan and diagrams.
                        </p>
                      </div>
                    </li>
                  </ol>
                  ...
                  <div className="bg-primary-50 border-l-4 border-primary-600 p-4 rounded-r-lg mb-8 mt-8">
                    ...
                    <p className="text-secondary-700">
                      Over 60% of businesses without proper emergency plans fail
                      to reopen after a major incident. Don&apos;t take the risk
                      with your business.
                    </p>
                  </div>
          ...
          <div className="mt-20 max-w-4xl mx-auto">
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100">
              ...
              <div className="border-b border-gray-200">
                ...
                >
                  <span className="font-medium text-lg">
                    How often should our emergency plan be reviewed?
                  </span>
                  <svg
                ...
                {isFaqOpen1 && (
                  <div className="faq-answer px-6 pb-6">
                    <p className="text-secondary-600">
                      AS3745-2010 requires emergency plans to be reviewed at
                      least every 12 months, or whenever there are significant
                      changes to:
                    </p>
              ...
              <div className="border-b border-gray-200">
                ...
                >
                  <span className="font-medium text-lg">
                    What&apos;s the difference between an emergency plan and
                    evacuation diagrams?
                  </span>
                  <svg
                    className="w-5 h-5 text-primary-500 transform transition-transform"
                ...
                {isFaqOpen2 && (
                  <div className="faq-answer px-6 pb-6">
                    <p className="text-secondary-600">
                      While both are required under AS3745-2010, they serve
                      different purposes:
                    </p>
                    <div className="mt-4 grid md:grid-cols-2 gap-6">
                      <div className="bg-primary-50 p-4 rounded-lg">
                        ...
                        <p className="text-secondary-700 text-sm">
                          A comprehensive document detailing all emergency
                          procedures, roles, and responsibilities. It&apos;s the
                          &quot;instruction manual&quot; for emergencies.
                        </p>
                      </div>
                      <div className="bg-gray-100 p-4 rounded-lg">
                        ...
                        <p className="text-secondary-700 text-sm">
                          Visual representations of your floor plan showing exit
                          routes and emergency equipment. They&apos;re the
                          &quot;quick reference guides&quot; placed throughout
                          your premises.
                        </p>
                      </div>
                    </div>
              ...
              <div className="border-b border-gray-200">
                ...
                >
                  <span className="font-medium text-lg">
                    Do we need different plans for different types of
                    emergencies?
                  </span>
                  <svg
                    className="w-5 h-5 text-primary-500 transform transition-transform"
                ...
                {isFaqOpen3 && (
                  <div className="faq-answer px-6 pb-6">
                    <p className="text-secondary-600">
                      Your emergency plan should cover all potential emergencies
                      relevant to your workplace. We typically include:
                    </p>
              ...
              <div className="">
                ...
                >
                  <span className="font-medium text-lg">
                    How long does it take to develop an emergency plan?
                  </span>
                  <svg
                    className="w-5 h-5 text-primary-500 transform transition-transform"
                    fill="none"
                ...
                {isFaqOpen4 && (
                  <div className="faq-answer px-6 pb-6">
                    <p className="text-secondary-600">
                      The timeline depends on the size and complexity of your
                      workplace:
                    </p>
                    <div className="mt-4 space-y-4">
                      <div className="flex items-start">
                        <div className="bg-primary-100 text-primary-600 px-3 py-1 rounded-full text-sm font-bold mr-4">
                          1-3 Days
                        </div>
                        <div>
                          <h4 className="font-bold mb-1">
                          ...
                          <p className="text-secondary-600 text-sm">
                            Simple layouts with under 20 staff
                          </p>
                        </div>
                      </div>
                      <div className="flex items-start">
                      ...
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <p className="text-secondary-600 text-sm">
                            Industrial sites, hospitals, schools with special
                            requirements
                          </p>
                        </div>
                      </div>
          ...
          <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-lg overflow-hidden border border-gray-200">
            <div className="md:flex">
              ...
              <div className="md:w-3/5 p-8">
                ...
                <p className="text-secondary-600 mb-6">
                  Download our free guide to essential emergency procedures and
                  compliance requirements for Australian workplaces.
                </p>
                ...
                <form action={submitForm} className="space-y-4">
                  ...
                  <p className="text-xs text-gray-500">
                    We respect your privacy. By downloading, you agree to
                    receive occasional emails from FireSafe Compliance.
                  </p>
                </form>
              </div>
            </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-secondary-600 max-w-3xl mx-auto">
              We&apos;ve helped organizations across industries achieve full
            ...
            {[
              {
                ...
                logo: "/images/Anytime-Fitness-logo.png",
              },
              { name: "Downer Group", logo: "/images/Downer_Group_logo.png" },
              {
                name: "Queensland Bank",
                logo: "/images/Queensland_bank-logo.jpg",
              },
              { name: "Snap Fitness", logo: "/images/snapFitness_logo.png" },
              {
                name: "The Good Feet Store",
                logo: "/images/The_Good-Feet-Store_LOGO.jpg",
              },
      ...
      <section className="cta-bg text-white py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg max-w-3xl mx-auto mb-10 text-secondary-200">
            We&apos;re here to help you stay compliant and safe.
          </p>
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <a
              href="/contact"
              className="bg-white text-primary-10 px-8 py-3 rounded-lg font-bold hover:bg-gray-100 transition transform hover:-translate-y-0.2 shadow-lg hover:shadow-xl"
            >
              Contact Us
            </a>
            <button
              onClick={togglePopup}
              className="border-2 border-white text-white px-8 py-3 rounded-lg font-bold hover:bg-white hover:text-primary-600 transition transform hover:-translate-y-0.1"
            >
              Free Quote
            </button>
          </div>
