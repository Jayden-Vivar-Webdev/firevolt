...
export const metadata: Metadata = {
  title:
    "Fire Safety Training Brisbane | Warden & Evacuation Training | Firevolt",
  description:
  ...
  return (
    <>
          ...
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            ...
            <div className="lg:w-1/2">
              ...
              <p className="text-lg text-secondary-600 mb-8">
                Our engaging, practical training programs ensure your staff are
                prepared to respond effectively in emergency situations. We
                offer flexible training options to suit your business needs.
              </p>
              ...
              <div className="space-y-6 mb-8">
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-secondary-600">
                      Comprehensive instruction for emergency control
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="bg-white p-5 rounded-lg shadow-md border border-gray-100">
                    ...
                    <p className="text-secondary-600 text-sm">
                      On-site training at your location with hands-on practice
                      using real equipment in simulated scenarios.
                    </p>
                  </div>
                  <div className="bg-white p-5 rounded-lg shadow-md border border-gray-100">
                    <div className="flex items-center mb-3">
                    ...
                    <p className="text-secondary-600 text-sm">
                      Interactive virtual sessions with certified instructors,
                      perfect for remote teams or refresher courses.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="mb-16">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-secondary-600 max-w-3xl mx-auto">
                Our structured training programs cover all aspects of fire
                safety, from prevention to emergency response. Each module is
                designed to build practical skills and confidence.
              </p>
            </div>
          ...
          <div className="mb-16">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-secondary-600">
                Tailored programs designed for the unique fire safety challenges
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="text-center p-6 bg-gray-50 rounded-lg border border-gray-100">
                ...
                <p className="text-sm text-secondary-600">
                  High-rise evacuation, floor warden training
                </p>
              </div>
              ...
              <div className="text-center p-6 bg-gray-50 rounded-lg border border-gray-100">
                ...
                <p className="text-sm text-secondary-600">
                  Chemical hazards, machinery safety protocols
                </p>
              </div>
              ...
              <div className="text-center p-6 bg-gray-50 rounded-lg border border-gray-100">
                ...
                <p className="text-sm text-secondary-600">
                  Patient evacuation, medical equipment safety
                </p>
              </div>
              ...
              <div className="text-center p-6 bg-gray-50 rounded-lg border border-gray-100">
                ...
                <p className="text-sm text-secondary-600">
                  Student safety, large group management
                </p>
              </div>
            </div>
          </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-secondary-700 text-sm">
                        All trainers are certified fire safety professionals
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-secondary-700 text-sm">
                        Track progress with assessments and practical
                        evaluations
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-secondary-700 text-sm">
                        Training sessions scheduled around your business
                        operations
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-secondary-700 text-sm">
                        Complete training records and certificates for
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-secondary-600">
              Hear from businesses who have transformed their fire safety
              culture
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-xl shadow-md border border-gray-100">
              ...
              <p className="text-secondary-600 mb-4 italic">
                &ldquo;Great training today with Fire volt. Very informative and
                professional whilst creating a fantastic fun and learning
                environment. Would highly recommend.&rdquo;
              </p>
              <div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md border border-gray-100">
              ...
              <p className="text-secondary-600 mb-4 italic">
                &ldquo;We have had our Fire Equipment and Emergency plans
                recently maintained by Firevolt. The communication, timeliness
                and requirements were impeccable. Firevolt provided us with our
                Fire training today.&rdquo;
              </p>
              <div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md border border-gray-100">
              ...
              <p className="text-secondary-600 mb-4 italic">
                &ldquo;Thanks so much for our training today at Apollo. Very
                well done and clearly explained and good to get everyone
                involved to learn how to handle a fire blanket and
                extinguisher.&rdquo;
              </p>
              <div>
      ...
      <section className="py-16 bg-primary-600 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">
            Ready to Enhance Your Fire Safety Training?
          </h2>
          <p className="text-xl mb-8 opacity-90 max-w-3xl mx-auto">
            Don&apos;t wait for an emergency to discover gaps in your
            team&apos;s fire safety knowledge. Book a consultation today and let
            us create a customized training program for your business.
          </p>

          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8">
            <a
              href="/contact"
              className="bg-white text-primary-600 hover:bg-gray-100 px-8 py-4 rounded-lg font-bold text-lg transition shadow-lg hover:shadow-xl"
            >
